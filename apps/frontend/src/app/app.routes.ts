...
import { PowermoveEditComponent } from 'libs/frontend/features/src/lib/powermove/powermove-edit/powermove-edit.component';
...
export const appRoutes: Routes= [
    ...
    { path: "powermove-edit/:id", component: PowermoveEditComponent}
];
